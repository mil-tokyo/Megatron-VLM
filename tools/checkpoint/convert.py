...
def main():
    ...
    parser.add_argument('--model-type', type=str, required=True,
                        choices=['GPT', 'BERT', 'LLaVA'],  # ADD LLaVA
    ...
    parser.add_argument('--no-checking', action='store_false',
                        ...
                        dest='checking')
    # parser.add_argument('--params_dtype', type=str, default='fp32')
    parser.add_argument('--params_dtype', type=str, default='bf16')

    # ADDED
    parser.add_argument('--use-dist-ckpt', action='store_true')
    parser.add_argument('--freeze-LM', action='store_true', default=False)
