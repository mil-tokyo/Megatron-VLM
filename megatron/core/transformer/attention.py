...
from megatron.core.transformer.custom_layers._transformer_engine import SplitAlongDim
...
class Attention(MegatronModule, ABC):
    ...
    def forward(
        ...
        if self.checkpoint_core_attention and self.training:
            ...
            core_attn_out = self.core_attention(  # TEDotProductAttention
                query,
                key,
                value,
                attention_mask,
...
class SelfAttention(Attention):
    ...
    def get_query_key_value_tensors(self, hidden_states, key_value_states=None):
        ...
        # (Pdb) self.linear_qkv
        # TEColumnParallelLinear(in_features=1024, out_features=3072, bias=True)
