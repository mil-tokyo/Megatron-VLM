...
def forward_backward_pipelining_without_interleaving(
    *,
    ...
    config: TransformerConfig = get_model_config(model)
    if config.overlap_p2p_comm:
        raise ValueError(
    ...
    # refer to scripts/train/dataset_helpers.py:350
    # and scripts/train/pretrain_vlm.py:138
    pp_seq_length = seq_length + 4 + (decoder_seq_length - seq_length) - 1
