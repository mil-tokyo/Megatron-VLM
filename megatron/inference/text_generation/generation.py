...
def generate_tokens_probs_and_return_on_first_stage(
    ...
    # Lengths of generated sequence including including prompts.
            ...
            if mpu.is_pipeline_last_stage():
                ...
                if return_output_log_probs:
                    ...
                    if return_output_log_probs:
                        ...
                        output_log_probs[:, prev_context_length:context_length] = torch.gather(log_probs, 2, indices).squeeze(2)
