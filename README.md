# Customized Megatron-LM for the VLM (LLaVA) training
readme for this project is located in the `scripts` directory. Please refer to the [readme](./scripts/readme.md) for more information.
